...
#include "SnakeCalibr/FrameSLAM.h"
#include <cmath>
...
void FrameSLAM::updateTheta(const std::vector<double> &joint_angle) {
    this->theta_.clear();
    for (auto &angle: joint_angle) {
        this->theta_.push_back(-1 * angle);
    }
